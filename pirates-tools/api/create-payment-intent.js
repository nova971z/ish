// POST /api/create-payment-intent — Creates a payment provider PaymentIntent for Elements.
...
module.exports = async function handler(req, res) {
  ...
  // A4 — endpoint public : borne la création d'objets chez le fournisseur (pollution
  ...
  try {
    ...
    // attachée au PaymentIntent (visible côté fournisseur/antifraude, relue par le
    ...
    if (amountCents < 50) {
      // Remise ramenant sous le minimum du fournisseur : on la tronque plutôt que
    ...
    return res.status(200).json({
      ...
      /* ⚠️ QUEL WIDGET MONTER — ajouté le 31/07/2026 (étape 4).
         ...
         widget du fournisseur sur un jeton Revolut : le formulaire ne s'afficherait
