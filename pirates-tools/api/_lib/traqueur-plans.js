...
var PLANS = {
  ...
  'MILWAUKEE@idealo': {
    ...
    note: '⛔⛔ CE QUE SON PREMIER BALAYAGE A MESURÉ, ET QUI CHANGE LE CHANTIER '
      ...
      + 'titres détaillés : 787 portent un numéro d\'article à DIX CHIFFRES que rien '
      + 'ne reconnaît — 738 références distinctes récupérables à ce seul motif ; '
      + '521 portent une référence de plateforme (M18…, M12…) ; 843 n\'affichent '
      + 'vraiment rien. '
      + '⛔⛔ L\'ANCRE EST LA FORME, JAMAIS LA POSITION — ET C\'EST LUI QUI M\'A REPRIS : '
      + '« elles ne sont pas toujours dans des parenthèses ». Mesuré sur ses 793 '
      + 'occurrences : 393 entre parenthèses (49,6 %), 280 après un tiret (35,3 %), '
      + '74 nues en fin de titre (9,3 %), 46 ailleurs — parfois même AVANT le nom du '
      + 'produit (« milw Milwaukee 4931391452 Pince de serrage »). S\'ancrer sur les '
      + 'parenthèses aurait perdu 400 références sur 793, soit la moitié. Ce qui est '
      + 'STABLE, c\'est la forme : mesuré, les 791 nombres à dix chiffres du relevé '
      + 'commencent TOUS par « 49 », sans une exception, et seuls 2 titres sur 2 151 '
      + 'en portent plusieurs. Une seconde famille existe à HUIT chiffres (128 en '
      + '« 48 », 105 en « 49 »). '
