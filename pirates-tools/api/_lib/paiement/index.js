...
var OPERATIONS = [
  ...
  /* () → true (test) | false (argent réel) | null (indéterminable)
     ...
     paiements de l'ancien fournisseur en mode TEST. Le filet disait vrai — ils ne sont pas dans
...
/* ⛔ UN SEUL FOURNISSEUR ENCAISSE : REVOLUT (01/08/2026, demande de l'user —
   « toute la partie de l'ancien fournisseur ne doit plus être présente »).
...
/* ⛔⛔ QUI A ENVOYÉ CETTE NOTIFICATION ? — trouvé le 01/08/2026 sur un test réel.
   ...
   notification tardive de l'ancien fournisseur (son backoff s'étale sur ~3 jours) serait refusée par Revolut,
