...
const r = await page.evaluate(() => {
  ...
  host.style.cssText='position:fixed;left:0;top:0;width:760px;z-index:99999;background:#0a0f14';
...
await page.locator('#__mapTest').screenshot({path:'/tmp/claude-0/-home-user-ish/5fdd6ad4-f914-5559-9038-8318b9646f86/scratchpad/carte-propre.png'});
console.log('\n'+pass+' OK / '+fail+' KO   → capture : carte-propre.png');
