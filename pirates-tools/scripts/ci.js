/* =========================================================
   ...
   - Agrège: audit/p1-static (intégrité statique AST), audit/p2-xss (injection HTML), audit/p3-* (securite serveur + aiguillage reel), audit/p4-firestore (regles + index), audit/p5-money (machine a etats + taux), audit/p6-rgpd (effacement + information), check-required-ids, check-paths, check-products-json
