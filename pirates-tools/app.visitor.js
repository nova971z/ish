/* GÉNÉRÉ par scripts/extraire-admin.js depuis app.js — NE PAS ÉDITER. */
/* ============================================================
...
(function () {
  ...
  Object.defineProperty(__A, 'COMPTA_VEILLE', { get: function () { return COMPTA_VEILLE; }, set: function (v) { COMPTA_VEILLE = v; }, configurable: true });
  Object.defineProperty(__A, 'COMPTA_VEILLE_KEY', { get: function () { return COMPTA_VEILLE_KEY; }, set: function (v) { COMPTA_VEILLE_KEY = v; }, configurable: true });
  Object.defineProperty(__A, 'COUNTRY_LATLNG', { get: function () { return COUNTRY_LATLNG; }, set: function (v) { COUNTRY_LATLNG = v; }, configurable: true });
  Object.defineProperty(__A, 'FISC_DECLARATIONS', { get: function () { return FISC_DECLARATIONS; }, set: function (v) { FISC_DECLARATIONS = v; }, configurable: true });
  Object.defineProperty(__A, 'FISC_DONE_KEY', { get: function () { return FISC_DONE_KEY; }, set: function (v) { FISC_DONE_KEY = v; }, configurable: true });
  Object.defineProperty(__A, 'LV_BAREME', { get: function () { return LV_BAREME; }, set: function (v) { LV_BAREME = v; }, configurable: true });
  Object.defineProperty(__A, 'LV_CYL', { get: function () { return LV_CYL; }, set: function (v) { LV_CYL = v; }, configurable: true });
  Object.defineProperty(__A, 'LV_FUEL_DEFAULT', { get: function () { return LV_FUEL_DEFAULT; }, set: function (v) { LV_FUEL_DEFAULT = v; }, configurable: true });
  Object.defineProperty(__A, 'LV_PIECES_BASE', { get: function () { return LV_PIECES_BASE; }, set: function (v) { LV_PIECES_BASE = v; }, configurable: true });
  Object.defineProperty(__A, 'LV_PIECES_EXTRA', { get: function () { return LV_PIECES_EXTRA; }, set: function (v) { LV_PIECES_EXTRA = v; }, configurable: true });
  ...
  Object.defineProperty(__A, '_adminPartnerLogo', { get: function () { return _adminPartnerLogo; }, set: function (v) { _adminPartnerLogo = v; }, configurable: true });
  Object.defineProperty(__A, '_adminPartnerPhotos', { get: function () { return _adminPartnerPhotos; }, set: function (v) { _adminPartnerPhotos = v; }, configurable: true });
  ...
  Object.defineProperty(__A, '_igDraftCreationId', { get: function () { return _igDraftCreationId; }, set: function (v) { _igDraftCreationId = v; }, configurable: true });
  Object.defineProperty(__A, '_lvAdminFuel', { get: function () { return _lvAdminFuel; }, set: function (v) { _lvAdminFuel = v; }, configurable: true });
  Object.defineProperty(__A, '_marginsLoaded', { get: function () { return _marginsLoaded; }, set: function (v) { _marginsLoaded = v; }, configurable: true });
  Object.defineProperty(__A, '_revolutDerniereCommande', { get: function () { return _revolutDerniereCommande; }, set: function (v) { _revolutDerniereCommande = v; }, configurable: true });
  Object.defineProperty(__A, 'addToCart', { get: function () { return addToCart; }, set: function (v) { addToCart = v; }, configurable: true });
  Object.defineProperty(__A, 'adminAuthHeaders', { get: function () { return adminAuthHeaders; }, set: function (v) { adminAuthHeaders = v; }, configurable: true });
  Object.defineProperty(__A, 'adminGet', { get: function () { return adminGet; }, set: function (v) { adminGet = v; }, configurable: true });
  Object.defineProperty(__A, 'adminPostType', { get: function () { return adminPostType; }, set: function (v) { adminPostType = v; }, configurable: true });
  Object.defineProperty(__A, 'apiBaseUrl', { get: function () { return apiBaseUrl; }, set: function (v) { apiBaseUrl = v; }, configurable: true });
  Object.defineProperty(__A, 'barRows', { get: function () { return barRows; }, set: function (v) { barRows = v; }, configurable: true });
  Object.defineProperty(__A, 'compressPartnerImage', { get: function () { return compressPartnerImage; }, set: function (v) { compressPartnerImage = v; }, configurable: true });
  Object.defineProperty(__A, 'countryName', { get: function () { return countryName; }, set: function (v) { countryName = v; }, configurable: true });
  Object.defineProperty(__A, 'destroyAdminGlobe', { get: function () { return destroyAdminGlobe; }, set: function (v) { destroyAdminGlobe = v; }, configurable: true });
  Object.defineProperty(__A, 'ensureDetail', { get: function () { return ensureDetail; }, set: function (v) { ensureDetail = v; }, configurable: true });
  Object.defineProperty(__A, 'ensureThree', { get: function () { return ensureThree; }, set: function (v) { ensureThree = v; }, configurable: true });
  Object.defineProperty(__A, 'escapeHTML', { get: function () { return escapeHTML; }, set: function (v) { escapeHTML = v; }, configurable: true });
  Object.defineProperty(__A, 'fiscDone', { get: function () { return fiscDone; }, set: function (v) { fiscDone = v; }, configurable: true });
  Object.defineProperty(__A, 'fmtDuration', { get: function () { return fmtDuration; }, set: function (v) { fmtDuration = v; }, configurable: true });
  Object.defineProperty(__A, 'formatPrice', { get: function () { return formatPrice; }, set: function (v) { formatPrice = v; }, configurable: true });
  Object.defineProperty(__A, 'formatReviewDate', { get: function () { return formatReviewDate; }, set: function (v) { formatReviewDate = v; }, configurable: true });
  Object.defineProperty(__A, 'igApiFetch', { get: function () { return igApiFetch; }, set: function (v) { igApiFetch = v; }, configurable: true });
  Object.defineProperty(__A, 'igLoadComments', { get: function () { return igLoadComments; }, set: function (v) { igLoadComments = v; }, configurable: true });
  Object.defineProperty(__A, 'igLoadMedia', { get: function () { return igLoadMedia; }, set: function (v) { igLoadMedia = v; }, configurable: true });
  Object.defineProperty(__A, 'isSafePartnerImg', { get: function () { return isSafePartnerImg; }, set: function (v) { isSafePartnerImg = v; }, configurable: true });
  Object.defineProperty(__A, 'latLngToVec3', { get: function () { return latLngToVec3; }, set: function (v) { latLngToVec3 = v; }, configurable: true });
  Object.defineProperty(__A, 'loadCoastline', { get: function () { return loadCoastline; }, set: function (v) { loadCoastline = v; }, configurable: true });
  Object.defineProperty(__A, 'lvConsoGp', { get: function () { return lvConsoGp; }, set: function (v) { lvConsoGp = v; }, configurable: true });
  Object.defineProperty(__A, 'lvResetRole', { get: function () { return lvResetRole; }, set: function (v) { lvResetRole = v; }, configurable: true });
  Object.defineProperty(__A, 'lvVehLabel', { get: function () { return lvVehLabel; }, set: function (v) { lvVehLabel = v; }, configurable: true });
  Object.defineProperty(__A, 'porteAdmin', { get: function () { return porteAdmin; }, set: function (v) { porteAdmin = v; }, configurable: true });
  Object.defineProperty(__A, 'productTitleByKey', { get: function () { return productTitleByKey; }, set: function (v) { productTitleByKey = v; }, configurable: true });
  Object.defineProperty(__A, 'products', { get: function () { return products; }, set: function (v) { products = v; }, configurable: true });
  Object.defineProperty(__A, 'safeImgSrc', { get: function () { return safeImgSrc; }, set: function (v) { safeImgSrc = v; }, configurable: true });
  Object.defineProperty(__A, 'setAdminSecret', { get: function () { return setAdminSecret; }, set: function (v) { setAdminSecret = v; }, configurable: true });
  Object.defineProperty(__A, 'statCard', { get: function () { return statCard; }, set: function (v) { statCard = v; }, configurable: true });
  Object.defineProperty(__A, 'toast', { get: function () { return toast; }, set: function (v) { toast = v; }, configurable: true });
  Object.defineProperty(__A, 'updateAccLivBtn', { get: function () { return updateAccLivBtn; }, set: function (v) { updateAccLivBtn = v; }, configurable: true });
  ...
  function chargerAdmin() {
    ...
    __adminCharge = new Promise(function (res, rej) {
      var s = document.createElement('script'); s.src = 'admin.bundle.js?v=599';
      s.onload = res; s.onerror = function () { __adminCharge = null; rej(new Error('admin.bundle indisponible')); };
      document.head.appendChild(s);
    });
    return __adminCharge;
  }
  function renderAdmin() { var a = arguments; return chargerAdmin().then(function () { return window.__PT_ADMIN.renderAdmin.apply(null, a); }); }
  function renderAjoutProduit() { var a = arguments; return chargerAdmin().then(function () { return window.__PT_ADMIN.renderAjoutProduit.apply(null, a); }); }
