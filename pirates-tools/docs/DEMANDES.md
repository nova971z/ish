...
| D-68 | Pourquoi la DJV185Z est passée de 252,44 € à 256,75 € alors que Revolut coûte moins que Stripe ? | 02/08 | `FAIT` | Mesuré en inversant le modèle : à COÛT ÉGAL, le passage 1,5 %+0,25 → 1 %+0,20 fait BAISSER le prix (~−1,80 € sur ce produit). La hausse vient du COÛT D'ACHAT : 256,75 € implique ≈ 152,46 € de coût aujourd'hui, 252,44 € impliquait ≈ 147,54 € à l'époque (+4,92 €) — le traqueur suit le tarif réel du fournisseur, 2×/jour. ⚠️ Vérifiable sur son écran admin (srcTTC de DJV185Z ≈ 152 €) — les coûts vivent en Firestore, illisibles depuis le dépôt. |
