...
| D-61 | Adapter le parseur au format de clickoutil | 01/08 | `FAIT` | L'user a fourni mieux qu'un diagnostic : **la page entière** (presse-papier du raccourci collé dans un document Pages, décompressé — 554 titres). `parseClickoutil` mesuré dessus : **147 produits lus** (réf avant la marque, prix « € TTC », jamais le HT), **278 packs écartés et listés** (un prix de pack ne s'écrit jamais sur une réf de composant — vérifié : cloueur nu 729 €, ses packs 888/818 € ignorés), 138 sans réf sûre listés. 1er jet corrigé sur mesure : 147/147 « promos » → le HT suivait toujours le TTC ; désormais 114 réelles. `parseAuto` aiguille les formats. Porte étendue, 3 sabotages rouges. **Reste son geste** : `dryRun=1` (attendu ≈ 147) puis `dryRun=0`. |
